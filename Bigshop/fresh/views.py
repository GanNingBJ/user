...
def register(request):
    context={'title':'用户注册'}
    return render(request,'fresh/register.html',context)
...
def info(request):
    ...
    if goods_ids!='':
        goods_ids1=goods_ids.split(',')#['1','2','3']
    ...
    return render(request,'fresh/user_center_info.html',context)
...
def order(request,pindex):
    ...
    context={'title':'用户中心',
             ...
             'paginator':paginator,
             'page':page,}
    return render(request,'fresh/user_center_order.html',context)
